...
bible.BOOK_DATA = {
	...
	*/	
	"Tob": {
			"chapters":[22, 14, 17, 21, 22, 18, 17, 21, 6, 13, 18, 21, 17, 15],
		"names":{"eng":["Tobit"]}
	},
	"Jdt":{
	...
	"Sir":{
		"chapters":[35, 30, 18, 31, 31, 15, 37, 36, 19, 18, 31, 34, 18, 26, 27, 20, 30, 32, 33, 30, 31, 28, 27, 27, 34, 26, 29, 30, 26, 28, 25, 31, 24, 33, 26, 24, 27, 31, 34, 35, 30, 27, 25, 33, 23, 26, 20, 25, 25, 16, 29, 30],
 ...
 */
bible.OT_BOOKS = ["Gen","Exod","Lev","Num","Deut","Josh","Judg","Ruth","1Sam","2Sam","1Kgs","2Kgs","1Chr","2Chr","Ezra","Neh","Tob","Jdt","Esth","1Macc","2Macc","Job","Ps","Prov","Eccl","Song","Wis","Sir","Isa","Jer","Lam","Bar","Ezek","Dan","Hos","Joel","Amos","Obad","Jonah","Mic","Nah","Hab","Zeph","Hag","Zech","Mal"];
 ...
 */
bible.AP_BOOKS = ["AddEsth","EpJer","PrAzar","Sus","Bel","3Macc","4Macc","1Esd","2Esd","Ps151"];
...
bible.addNames("fre",bible.DEFAULT_BIBLE,[
 ["Genèse","Gn"],  ["Exode","Ex"],  ["Lévitique","Lv"],  ["Nombres","Nb"],  ["Deutéronome","Dt"],  ["Josué","Jos"],  ["Juges","Jg"],  ["Ruth","Rt"],  ["1 Samuel","1 S"],  ["2 Samuel","2 S"],  ["1 Rois","1 R"],  ["2 Rois","2 R"],  ["1 Chroniques","1 Ch"],  ["2 Chroniques","2 Ch"],  ["Esdras","Esd"],  ["Néhémie","Ne"],["Tobie","Tb"],["Judith","Jdt"],  ["Esther","Est"],["1 Maccabées","1 M"],["2 Maccabées","2 M"],  ["Job","Jb"],  ["Psaumes","Ps"],  ["Proverbes","Pr"],  ["Ecclésiaste","Qo"],  ["Cantique","Ct"],["Sagesse","Sg"],["Siracide","Si"],  ["Isaïe","Is"],  ["Jérémie","Jr"],  ["Lamentations","Lm"],["Baruch","Ba"],  ["Ezéchiel","Ez"],  ["Daniel","Dn"],  ["Osée","Os"],  ["Joël","Jl"],  ["Amos","Am"],  ["Abdias","Ab"],  ["Jonas","Jon"],  ["Michée","Mi"],  ["Nahum","Na"],  ["Habacuc","Ha"],  ["Sophonie","So"],  ["Aggée","Ag"],  ["Zacharie","Za"],  ["Malachie","Ml"],  ["Matthieu","Mt"],  ["Marc","Mc"],  ["Luc","Lc"],  ["Jean","Jn"],  ["Actes","Ac"],  ["Romains","Rm"],  ["1 Corinthiens","1 Co"],  ["2 Corinthiens","2 Co"],  ["Galates","Ga"],  ["Ephésiens","Ep"],  ["Philippiens","Ph"],  ["Colossiens","Col"],  ["1 Thessalonicien","1 Th"],  ["2 Thessalonicien","2 Th"],  ["1 Timothée","1 Tm"],  ["2 Timothée","2 Tm"],  ["Tite","Tt"],  ["Philemon","Phm"],  ["Hébreux","He"],  ["Jacques","Jc"],  ["1 Pierre","1 P"],  ["2 Pierre","2 P"],  ["1 Jean","1 Jn"],  ["2 Jean","2 Jn"],  ["3 Jean","3 Jn"],  ["Jude","Jude"],  ["Apocalypse","Ap"]]);
